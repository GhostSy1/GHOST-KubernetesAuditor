...
VERSION = "3.0-PRO"
PROFILE = "Kubernetes cluster and RBAC privilege auditor"
RULES = [('K8S-RBAC', 'ClusterRole|ClusterRoleBinding|cluster-admin|verbs:\\s*\\[?\\s*\\*'), ('K8S-SECRET', 'kind:\\s*Secret|stringData|data:'), ('K8S-POD', 'securityContext|runAsNonRoot|readOnlyRootFilesystem')]
...
def render_banner() -> None:
 ...
 | |__| | | | | |__| | |__| || |_
  \\_____|_| |_|\\____/ \\____/_____|
      GHOST-KubernetesAuditor v3.0-PRO (Zero-Guessing Engine)
"""
    print(banner)
